...
<head>
	<meta charset="UTF-8">
	<title>Create a Vet Account</title>
	<link rel="stylesheet" href="decentStyle.css">
</head>
<body>
	<div>
		<h1 style = "text-align:center; margin: 2px;">Vet account creation for Dogs are Cool Vet Clinic</h1>
		<h3>Fill out this form to create and account.</h4>
		<form action="VetSignUpScript.php" method="POST">
